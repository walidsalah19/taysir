...
import com.example.taysir.Admin.AdminShowOldComplaintDirections;
import com.example.taysir.Models.OldComplaintModel;
import com.example.taysir.R;

import java.util.ArrayList;

public class OldComplaintAdapter extends RecyclerView.Adapter<OldComplaintAdapter.help> {
        private ArrayList<OldComplaintModel> arrayList;
        private Fragment fragment;
        public OldComplaintAdapter(ArrayList<OldComplaintModel> arrayList, Fragment fragment) {
