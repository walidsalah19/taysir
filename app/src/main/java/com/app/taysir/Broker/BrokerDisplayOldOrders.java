...
import com.app.taysir.databinding.FragmentBrokerDisplayOldOrdersBinding;
...
public class BrokerDisplayOldOrders extends Fragment {
    ...
    private void recyclerViewComponent()
    {
        ...
        adapter=new BrokerOrderAdapter(order,this,"old");
        mBinding.BrokerDisplayOldOrders.setLayoutManager(new LinearLayoutManager(getActivity()));
        mBinding.BrokerDisplayOldOrders.setAdapter(adapter);
        getNewOrders();
    }
