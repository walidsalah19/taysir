...
import com.app.taysir.Customer.Adapters.CustomerViewOrderAdapter;
...
import com.app.taysir.databinding.FragmentCustomerDisplayOldOrdersBinding;
...
public class CustomerDisplayOldOrders extends Fragment {
    private FragmentCustomerDisplayOldOrdersBinding mBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding=FragmentCustomerDisplayOldOrdersBinding.inflate(inflater,container,false);
    ...
    private void recyclerViewComponent()
    {
        ...
        adapter=new CustomerViewOrderAdapter(order,this,"old");
    ...
    private void back()
    {
        mBinding.back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(CustomerDisplayOldOrders.this)
